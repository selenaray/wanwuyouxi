...
优先列出画面中清晰可见、适合作为物证的实体，数量必须为 3–8 个。可选择日用品、家具、装饰物、门窗、桌面、墙面痕迹、地面痕迹等稳定可见对象；不要求必须可移动。每个 visualFacts 项只能描述可见的形状、位置和状态；不得补充不可见的信息。x、y、radius、confidence 必须是 0 到 1 的归一化数字。
